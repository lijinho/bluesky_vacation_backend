...
>>>>>>> 8336936ceba8c1d43a3f5dbc3dfccbc9fc386cee
    ...
    {
//        foreach (['start_date', 'reservation_id', 'reserveid', 'end_date', 'seasonal_name', 'edit_seasonal_name'
//                     , 'notes', 'reservation_source', 'price', 'guests', 'first_name', 'last_name', 'street_address_1',
//                     'street_address_2', 'city', 'state','postal_code', 'phone_number', 'email'] as $key) {
//            print("$key\t");
//            print_r($request[$key]);
//            print("\n");
//        }
        ...
        if (BookingHelper::isAvailable()) {
            $reservation_json = [
                ...
                "lastNight" => $lastNight,
                "numAdult" => $request->guests,
                "guestFirstName" => $request->first_name,
                "guestName" => $request->last_name,
                ...
                'checkAvailability' => false,
                'allowReview' => true,
                "guestAddress" => $request->street_address_1 . $request->street_address_2,
                "guestCity" => $request->city . ", " . $request->state,
                "guestPostcode" => $request->postal_code,
                "guestPhone" => $request->phone_number,
                "notes" => $request->notes
            ];
            if (isset($reserveid) && $reserveid > 0) {
                $reservation_json['bookId'] = $reserveid;
        ...
        if ($reservation_id > 0) {
            ...
            $reservationModel->first_name = $request->first_name;
            $reservationModel->last_name = $request->last_name;
            $reservationModel->postal_code = $request->postal_code;
            $reservationModel->street_address_1 = $request->street_address_1;
            $reservationModel->street_address_2 = $request->street_address_2;
            $reservationModel->city = $request->city;
            $reservationModel->state = $request->state;
            $reservationModel->phone_number = $request->phone_number;
            $reservationModel->email = $request->email;
            $reservationModel->save();
        }

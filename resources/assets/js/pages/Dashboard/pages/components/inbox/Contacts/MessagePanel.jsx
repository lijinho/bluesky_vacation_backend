...
class MessagePanel extends React.Component {
  ...
  componentDidMount() {
    Axios.get(
      ...
      () => {
        var chatDiv = document.getElementById(
  ...
  uploadFileFromClipboard(file) {
    ...
    axios
      .post("/ajax/chat/fileupload", formData, {
      ...
      <div className="message_content">
        ...
        <div className="message-input">
          ...
          <div className="wrap">
            ...
            <label
              htmlFor={"file" + this.props.contactUser.id}
              className="chat_file_upload_label"
            >
            ...
            />
            <button className="button" onClick={this.handleSendMessage}>

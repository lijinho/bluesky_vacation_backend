                          ...
                          <div className="col-md-12">
                            <div className="con-list">
                              ...
                              <div className="rel-in">
                                ...
                                <button type="submit"><i className="fab fa-telegram-plane" aria-hidden="true"  />
                                </button></div>
                            </div>
                          </div>
                        </form>
                    ...
                    <div className="con-r">
                      <div className="con-wrapper">
                        ...
                        <ul className="social-links">
                          <li>
                            <a href="https://www.facebook.com/www.vacation.rentals/"><i className="fab fa-facebook" /></a>
                          </li>
                      
                          <li>
                            <a href="https://twitter.com/Vacarent"><i className="fab fa-twitter" /></a>
                          </li>
                          <li>
                            <a href="https://www.linkedin.com/in/vacarent"><i className="fab fa-linkedin" /></a>
                          </li>

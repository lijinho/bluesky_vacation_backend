...
class PhotoItem extends React.Component {
  ...
  render() {
    ...
    return (
      <li
        className="col-12 col-lg-4 col-md-6 row-space-4 photo-item-container photo_drag_item slide "
      ...
      >
        <div className="panel photo-item">
          ...
          <div
            className="photo-size photo-drag-target js-photo-link"
            id="photo-79130"
          />
          <a
            className="media-photo media-photo-block text-center photo-size"
            href="#"
          >
          ...
          <button
            ...
            onClick={() => this.props.removeHandler(value.id)}
            distance={1}
          >
          ...
          <div className="panel-body panel-condensed">
            <textarea
              ...
              onChange={event => this.changeHighlight(event, value.id)}
            />

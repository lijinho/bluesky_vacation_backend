...
const index_page_data = JSON.parse(
  document.getElementById("page_json_data").innerHTML
);
    ...
    return (
      <main id="site-content" role="main">
        <div className=" shift-with-hiw js-hero">
          <Banner
            home_page_media={this.state.home_page_media}
            home_page_sliders={this.state.home_page_sliders}
          />
          <How />
          <Communicate />
          <Listing
            tags={this.state.tags}
            small_slide_data={this.state.small_slide_data}
          />
          <Popular />
              ...
              <div className="page-container-no-padding action_box_content row d-flex-lg align-content-center">
                ...
                <div className="ac-content-text col-sm-12 col-md-12 col-lg-9 mb-md-20">
                  ...
                  <h4 className="text text-center text-md-left ">
                    Ready to join the hundreds of homeowners and property
                    managers listing on{" "}
                    <span className="fw-bold">Vacation.Rentals?</span>
                  </h4>
                </div>
                ...
                <div className="ac-buttons col-sm-12 col-md-12 col-lg-3 d-flex align-self-center justify-content-center justify-content-lg-end">
                  <a
                    href="/rooms/new"
                    className="btn-lined btn-lg ac-btn w-100 text-center"
                    title="List your property with Vacation.Rentals"
                  >
                    Get Started!
                  </a>
                </div>

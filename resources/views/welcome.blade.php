...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        {{-- <link rel="preload" href="https://res.cloudinary.com/vacation-rentals/raw/upload/v1556551108/css/home/app.css"
            type="text/css" as="style" onload="this.rel='stylesheet'">
        <link rel="preload" type="text/css" charset="UTF-8"
            href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick.min.css" as="style"
        ...
        {{-- <link rel="preload" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick-theme.min.css"  as="style" onload='this.rel="stylesheet"'/>   --}}

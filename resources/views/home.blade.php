					...
					<div class="page-container-responsive page-container-no-padding">
						<div class="top_text_wrap">
							...
							<div class="how_it_sect col-lg-3 col-md-6 col-sm-12">
								<div class="how-it-img1"><img src="images/how12.png" alt="Vacation Rentals"></div>
								<h3>Search</h3>
								<p>Search for the perfect vacation home for rent from our verified listings</p>
							</div>
							<div class="how_it_sect col-lg-3 col-md-6 col-sm-12">
								<div class="how-it-img2"><img src="images/how22.png" alt="Vacation Rentals"></div>
								<h3>Make an inquiry</h3>
								<p>Contact the owner or property manager directly</p>
							</div>
							<div class="how_it_sect col-lg-3 col-md-6 col-sm-12">
								<div class="how-it-img3"><img src="images/rightclick1.png" alt="Vacation Rentals"></div>
							...
							<div class="how_it_sect col-lg-3 col-md-6 col-sm-12">
								<div class="how-it-img4"><img src="images/how42.png" alt="Vacation Rentals"></div>

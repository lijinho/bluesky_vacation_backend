...
<script type="text/javascript" src="{{asset('admin_assets/bower_components/clndr/src/clndr.js').'?t=1'}}"></script>
...
<script type="text/javascript" src="{{asset('admin_assets/assets/pages/clndr-calendar/js/clndr-custom.js').'?t=2'}}"></script>
<script type="text/javascript" src="{{asset('admin_assets/assets/pages/chart/morris/morris-custom-chart.js').'?t=2'}}"></script>

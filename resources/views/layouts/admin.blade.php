...
<html lang="en">
   <head>
      ...
      {{-- <link rel="preload" type="text/css" href="{{asset('admin_assets/bower_components/bootstrap/dist/css/bootstrap.min.css')}}" as="style" onload="this.rel='stylesheet'">      <link rel="preload" type="text/css" href="{{asset('admin_assets/bower_components/bootstrap/dist/css/bootstrap.min.css')}}" as="style" onload="this.rel='stylesheet'">
      <link rel="preload" type="text/css" href="{{asset('admin_assets/assets/icon/icofont/css/icofont.css')}}" as="style" onload="this.rel='stylesheet'">
       --}}
      ...
      {{-- <link rel="preload" type="text/css" href="{{asset('admin_assets/assets/css/style.css')}}" as="style" onload="this.rel='stylesheet'"> --}}
      ...
      {{-- <link rel="preload" type="text/css" href="{{asset('admin_assets/assets/css/jquery.mCustomScrollbar.css')}}" as="style" onload="this.rel='stylesheet'">      --}}
   ...
   <body>
            ...
            <nav class="navbar header-navbar pcoded-header" header-theme="theme4">
               <div class="navbar-wrapper">
                  <div class="navbar-logo">
                     ...
                     <a href="index-2.html">
                        <img class="img-fluid" src="{{asset('admin_assets/assets/images/logo.webp')}}" alt="Theme-Logo" />
                     </a>
                     ...
                     <div>
                        ...
                        <ul class="nav-right">
                           ...
                           <li class="user-profile header-notification">
                              <a href="#!">
                                 <img src="{{asset('admin_assets/assets/images/user.webp')}}" alt="User-Profile-Image">
      ...
      <script type="text/javascript" src="{{asset('admin_assets/assets/pages/advance-elements/moment-with-locales.min.js').'?t=1'}}"></script>
            
      <script type="text/javascript" src="{{asset('admin_assets/assets/js/script.js').'?t=1'}}"></script>
      ...
      <script src="{{asset('admin_assets/assets/js/pcoded.min.js').'?t=2'}}"></script>
      <script src="{{asset('admin_assets/assets/js/demo-12.js').'?t=2'}}"></script>
